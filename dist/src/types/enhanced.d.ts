 ...
 */
export type ChemicalElement = 'H' | 'He' | 'Li' | 'Be' | 'B' | 'C' | 'N' | 'O' | 'F' | 'Ne' | 'Na' | 'Mg' | 'Al' | 'Si' | 'P' | 'S' | 'Cl' | 'Ar' | 'K' | 'Ca' | 'Sc' | 'Ti' | 'V' | 'Cr' | 'Mn' | 'Fe' | 'Co' | 'Ni' | 'Cu' | 'Zn' | 'Ga' | 'Ge' | 'As' | 'Se' | 'Br' | 'Kr' | 'Rb' | 'Sr' | 'Y' | 'Zr' | 'Nb' | 'Mo' | 'Tc' | 'Ru' | 'Rh' | 'Pd' | 'Ag' | 'Cd' | 'In' | 'Sn' | 'Sb' | 'Te' | 'I' | 'Xe' | 'Cs' | 'Ba' | 'La' | 'Ce' | 'Pr' | 'Nd' | 'Pm' | 'Sm' | 'Eu' | 'Gd' | 'Tb' | 'Dy' | 'Ho' | 'Er' | 'Tm' | 'Yb' | 'Lu' | 'Hf' | 'Ta' | 'W' | 'Re' | 'Os' | 'Ir' | 'Pt' | 'Au' | 'Hg' | 'Tl' | 'Pb' | 'Bi' | 'Po' | 'At' | 'Rn' | 'Fr' | 'Ra' | 'Ac' | 'Th' | 'Pa' | 'U' | 'Np' | 'Pu' | 'Am' | 'Cm' | 'Bk' | 'Cf' | 'Es' | 'Fm' | 'Md' | 'No' | 'Lr' | 'Rf' | 'Db' | 'Sg' | 'Bh' | 'Hs' | 'Mt' | 'Ds' | 'Rg' | 'Cn' | 'Nh' | 'Fl' | 'Mc' | 'Lv' | 'Ts' | 'Og';
export type ValidChemicalFormula<T extends string> = T extends `${infer Element}${infer Rest}` ? Element extends ChemicalElement ? Rest extends '' ? T : Rest extends `${number}${infer Remaining}` ? ValidChemicalFormula<Remaining> : ValidChemicalFormula<Rest> : never : T extends '' ? T : never;
...
export interface TypeSafeEquation<TReactants extends readonly string[] = readonly string[], TProducts extends readonly string[] = readonly string[]> {
    readonly reactants: {
...
export interface EnhancedBalanceResult<TReactants extends readonly string[] = readonly string[], TProducts extends readonly string[] = readonly string[]> {
    ...
    readonly stoichiometry: {
        readonly calculate: <TTarget extends TReactants[number] | TProducts[number]>(target: TTarget, amount: number, unit: 'mol' | 'g' | 'L') => {
...
export interface TypeSafeThermodynamics<TTemp extends TemperatureUnit = 'K', TPress extends PressureUnit = 'Pa', TEnergy extends EnergyUnit = 'kJ'> {
...
export type ExtractElements<T extends string> = T extends `${infer E}${infer Rest}` ? E extends ChemicalElement ? E | ExtractElements<Rest> : ExtractElements<Rest> : never;
export declare function createCompound<T extends string>(formula: ValidChemicalFormula<T>): TypeSafeCompound<T>;
export declare function balanceEquation<TReactants extends readonly string[], TProducts extends readonly string[]>(reactants: {
    readonly [K in keyof TReactants]: ValidChemicalFormula<TReactants[K]>;
}, products: {
    readonly [K in keyof TProducts]: ValidChemicalFormula<TProducts[K]>;
}): EnhancedBalanceResult<TReactants, TProducts>;
export declare function calculateThermodynamics<TTemp extends TemperatureUnit = 'K', TPress extends PressureUnit = 'Pa', TEnergy extends EnergyUnit = 'kJ'>(conditions: {
    readonly temperature: {
        readonly value: number;
        readonly unit: TTemp;
    };
...
export type ContainsElement<T extends string, E extends ChemicalElement> = T extends `${string}${E}${string}` ? true : false;
export type MolarMass = number & {
    readonly __brand: 'MolarMass';
};
export type Temperature = number & {
    readonly __brand: 'Temperature';
};
export type Pressure = number & {
    readonly __brand: 'Pressure';
};
export type Concentration = number & {
    readonly __brand: 'Concentration';
};
