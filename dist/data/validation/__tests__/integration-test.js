 ...
 */
import { createValidationPipeline, createFastValidationPipeline, createThoroughValidationPipeline, validateChemicalFormula, validateThermodynamicProperties, ChemicalFormulaValidator, createCompositeValidator, createChemicalFormulaFormatRule, formatValidationErrors, summarizeValidationResult, hasOnlyWarnings, ValidationSeverity } from '../index';
 ...
 */
export async function testPipelineCreation() {
 ...
 */
export async function testQuickValidation() {
 ...
 */
export async function testValidatorComposition() {
    try {
 ...
 */
export async function testErrorFormatting() {
 ...
 */
export async function testRuleCreation() {
