 ...
 */
export function createFastValidationPipeline() {
    return new ValidationPipeline({
        timeout: 10000,
        enableCaching: true,
        cacheTTL: 600000,
 ...
 */
export function createThoroughValidationPipeline() {
    return new ValidationPipeline({
        timeout: 120000,
        enableCaching: false,
        cacheTTL: 0,
 ...
 */
export async function validateChemicalFormula(formula, config) {
 ...
 */
export async function validateThermodynamicProperties(properties) {
 ...
 */
export function summarizeValidationResult(result) {
 ...
 */
export function getMostSevereError(result) {
