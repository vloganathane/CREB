(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('events'), require('fs'), require('worker_threads'), require('url'), require('path'), require('crypto'), require('async_hooks'), require('perf_hooks')) :
    typeof define === 'function' && define.amd ? define(['exports', 'reflect-metadata', 'events', 'fs', 'worker_threads', 'url', 'path', 'crypto', 'async_hooks', 'perf_hooks'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CREB = {}, null, global.events, global.fs, global.worker_threads, global.url, global.path, global.crypto, global.async_hooks, global.perf_hooks));
})(this, (function (exports, reflectMetadata, events, fs, worker_threads, url, path, crypto, async_hooks, perf_hooks) { 'use strict';
