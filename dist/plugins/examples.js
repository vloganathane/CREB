 ...
 */
export function createDataProviderPlugin() {
    const metadata = {
 ...
 */
export function createSpecializedCalculatorPlugin() {
    const metadata = {
