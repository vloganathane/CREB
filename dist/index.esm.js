...
export { AdaptiveEvictionPolicy, AdvancedCache, AdvancedKineticsAnalyzer, CREBError, ValidationError as CREBValidationError, CacheFactory, CachedChemicalDatabase, CachedEquationBalancer, CachedThermodynamicsCalculator, ChemicalDatabaseManager, ChemicalEquationBalancer, ChemicalFormulaError, CircuitBreaker, CircuitBreakerManager, CircuitBreakerState, CircularDependencyError, ComputationError, ConfigManager, Container, DataValidationService, ELEMENTS_LIST, ElementCounter, EnergyProfileGenerator, EnhancedBalancer, EnhancedChemicalEquationBalancer, EnhancedNISTIntegration, EnhancedPubChemIntegration, EnhancedSQLiteStorage, EnhancedStoichiometry, EquationBalancingError, EquationParser, ErrorAggregator, ErrorCategory, ErrorSeverity, ErrorUtils, EvictionPolicyFactory, ExternalAPIError, FIFOEvictionPolicy, GracefulDegradationService, INJECTABLE_METADATA_KEY, Inject, Injectable, LFUEvictionPolicy, LRUEvictionPolicy, MaxDepthExceededError, MechanismAnalyzer, MultiLevelCache, NISTWebBookIntegration, NetworkError, Optional, PARAMETER_SYMBOLS, PERIODIC_TABLE, RandomEvictionPolicy, RateLimiter, ReactionKinetics, ReactionSafetyAnalyzer, RetryPolicies, RetryPolicy, RetryStrategy, ServiceLifetime$1 as ServiceLifetime, ServiceNotFoundError, Singleton, Stoichiometry, SystemError, SystemHealthMonitor, TTLEvictionPolicy, ThermodynamicsCalculator, ThermodynamicsEquationBalancer, Transient, WithCircuitBreaker, WithRetry, calculateMolarWeight, circuitBreakerManager, configManager, container, createChemicalFormula, createElementSymbol, createEnergyProfile, createRetryPolicy, createToken, defaultConfig, demonstrateAdvancedCaching, demonstrateEnhancedErrorHandling, exportEnergyProfile, generateSchemaDocumentation, getConfig, getDependencyTokens, getFullConfig, getInjectableMetadata, isBalancedEquation, isCREBConfig, isChemicalFormula, isElementSymbol, isInjectable, parseFormula, setConfig, validateConfig };
