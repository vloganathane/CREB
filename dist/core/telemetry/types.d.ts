...
export declare const PERFORMANCE_THRESHOLDS: {
    ...
    readonly SLOW_OPERATION: 1000;
    /** Very slow operation threshold in ms */
    readonly VERY_SLOW_OPERATION: 5000;
    /** High memory usage threshold in bytes */
    readonly HIGH_MEMORY_USAGE: number;
    /** High CPU usage threshold (percentage) */
    readonly HIGH_CPU_USAGE: 80;
};
/**
...
export declare const isLogEntry: (value: unknown) => value is LogEntry;
export declare const isMetric: (value: unknown) => value is Metric;
/**
 * Utility functions for creating branded types
 */
export declare const createCorrelationId: (id: string) => CorrelationId;
export declare const createTimestamp: (timestamp?: number) => Timestamp;
/**
