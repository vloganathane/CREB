 ...
 */
export function environmentVariableExample(): void {
...
export function configurationValidationExample(): void {
  ...
  const validUpdate: PartialCREBConfig = {
    cache: {
      maxSize: 8000,
      strategy: 'lfu'
    },
 ...
 */
export async function fileBasedConfigurationExample(): Promise<void> {
  ...
  const fileConfig: PartialCREBConfig = {
    cache: {
      maxSize: 15000,
 ...
 */
export function eventHandlingExample(): void {
 ...
 */
export function metadataAndHistoryExample(): void {
 ...
 */
export function documentationGenerationExample(): void {
...
export class ExampleChemistryCalculator {
  ...
  private reinitializeCalculationEngine(): void {
    console.log('Reinitializing calculation engine due to WASM setting change');
  }
  
  private updateBatchProcessing(): void {
 ...
 */
export function applicationIntegrationExample(): void {
 ...
 * Run all examples
 */
export async function runAllConfigurationExamples(): Promise<void> {
