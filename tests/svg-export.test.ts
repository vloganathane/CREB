...
describe('SVG Export System', () => {
  ...
  describe('SVGRenderer', () => {
    ...
    test('should include metadata when requested', () => {
      ...
      expect(svg).toContain('<atomCount>3</atomCount>');
      expect(svg).toContain('<bondCount>2</bondCount>');
    });
    ...
    test('should render bonds correctly', () => {
      ...
      expect(svg).toContain('class="bond-line"');
    });
  ...
  describe('Canvas2DRenderer SVG Export', () => {
    ...
    test('should export SVG with advanced options', () => {
      ...
      expect(svg).toContain('data-element');
  ...
  describe('Export Performance', () => {
    ...
    test('should handle larger molecules efficiently', () => {
      ...
      expect(svg).toContain('<atomCount>20</atomCount>');
      expect(svg).toContain('<bondCount>19</bondCount>');
    });
  });
